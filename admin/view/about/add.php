	...
	<div class="container ">
		<div class="row">
			<div class="col-8 mx-auto ">
				<b> افزودن عضو جدید</b>
				<form action="index.php?c=about&a=add" method="POST" enctype="multipart/form-data" class="mt-4">
					<div class="form-group row my-5">
						<label class="form-control-lable col-12 col-md-4"> نام و نام خانوادگی عضو </label>
						<input type="text" class="form-control col-12 col-md-8" placeholder=" نام و نام خانوادگی عضو را وارد کنید." name="frm[name]" required>
					</div>
					<div class="form-group row my-5">
						<label class="form-control-lable col-12 col-md-4"> سمت عضو </label>
						<input type="text" class="form-control col-12 col-md-8" placeholder="  سمت عضو را وارد کنید." name="frm[user_role]" required>
					</div>
					<div class="form-group row my-5">
