	...
	<div class="container ">
		<div class="row">
			<div class="col-8 mx-auto ">
				<form action="dashbord.php?c=person&a=changepass" method="POST" enctype="multipart/form-data" class="mt-4">
					...
					<div class="form-group  row ">
						...
						<div class="col-5 col-md-4 ">
							<a href="dashbord.php" class="btn btn-danger px-4 py-2 "> انصراف</a>
						</div>
					</div>
				</form>
			</div>
