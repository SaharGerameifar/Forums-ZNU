	...
	<div class="container ">
		<div class="row">
			<div class="col-8 mx-auto ">
				<form action="index.php?c=paper&a=editcomment&id=<?php echo $result['id']; ?>" method="POST" class="mt-4">
					<div class="form-group row my-5">
						<label class="form-control-lable col-12 col-md-4"> دیدگاه مرتبط به دوره</label>
						<p class="form-control col-12 col-md-8">
							<?php $row = $paper->comment_list_paper($result['paper_id']);
							echo $row['title']; ?>
						</p>
					</div>
					<div class="form-group row my-5">
					...
					<div class="form-group  row ">
						...
						<div class="col-5 col-md-4 ">
							<a href="index.php?c=paper&a=listcomment" class="btn btn-danger px-4 py-2 "> انصراف</a>
						</div>
					</div>
