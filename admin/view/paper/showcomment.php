...
<div class="  mt-4">
	...
	<div class="my-body-show ">
		...
		foreach ($results as $result) : ?>
			<div class="m-4">
				<p class=" badge-secondary p-3">نام پاسخ دهنده: <?php echo $result['name']; ?><a href="index.php?c=paper&a=deletecomment&id=<?php echo $result['id']; ?>" class="btn btn-sm btn-danger float-left">حذف </a></p>
				<hr>
...
<div>
	<a href="index.php?c=paper&a=listcomment" class="btn btn-sm btn-danger float-left px-4 py-2 my-5">بازگشت به صفحه قبل</a>
</div>